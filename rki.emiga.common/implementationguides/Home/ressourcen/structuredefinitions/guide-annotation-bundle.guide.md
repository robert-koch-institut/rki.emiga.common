---
topic: AnnotationBundle
canonical: https://emiga.rki.de/fhir/common/StructureDefinition/AnnotationBundle
---
...
## Beispiel
Im Folgenden wird ein Beispiel für ein Annotation Bundle dargestellt.

<tabs>
    <tab title="Übersicht">      
        {{render:Bundle-TransactionBundle.json}}
    </tab>
    <tab title="XML">      
        {{xml:Bundle-TransactionBundle.json}}
    </tab>
    <tab title="JSON">
        {{json:Bundle-TransactionBundle.json}}
    </tab>
    <tab title="Link">
        {{link:Bundle-TransactionBundle.json}}
    </tab>
</tabs>

<!-- {{json: Bundle/TransactionBundle}} -->