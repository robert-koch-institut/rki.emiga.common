---
topic: AdditionalPropertiesQuestionnaireResponse
canonical: https://emiga.rki.de/fhir/common/StructureDefinition/AdditionalPropertiesQuestionnaireResponse
---
...
<tabs>
    <tab title="Übersicht">      
        {{render:QuestionnaireResponse-FillingNoteResponse.json}}
    </tab>
    <tab title="XML">      
        {{xml:QuestionnaireResponse-FillingNoteResponse.json}}
    </tab>
    <tab title="JSON">
        {{json:QuestionnaireResponse-FillingNoteResponse.json}}
    </tab>
    <tab title="Link">
        {{link:QuestionnaireResponse-FillingNoteResponse.json}}
    </tab>
</tabs>

<!-- {{json: QuestionnaireResponse/FillingNoteResponse}} -->