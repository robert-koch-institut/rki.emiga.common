...
Description: "Extension für die Abbildung der Einrichtungsadresse. Über eine Einrichtungsadresse kann eine Einrichtung als Aufenthaltsort für die Betroffene Person angegeben werden."
Context: Patient
