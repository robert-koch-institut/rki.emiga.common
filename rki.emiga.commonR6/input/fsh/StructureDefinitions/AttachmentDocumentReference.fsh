Profile: AttachmentDocumentReferenceR6
Parent: DocumentReference
Id: AttachmentDocumentReferenceR6
...
* ^url = "https://emiga.rki.de/fhir/common/StructureDefinition/AttachmentDocumentReferenceR6"
...
* meta.profile[emigaprofile] = "https://emiga.rki.de/fhir/common/StructureDefinition/AttachmentDocumentReferenceR6"
/*
* meta.tag MS
...
* author ..1 MS
* author only Reference(EmigaUserPractitionerR6)
...
// Derzeit für Emiga Anwendungsfälle nicht relevant
// AUTO-DISABLED (SUSHI R6): * authenticator 0..0
// AUTO-DISABLED (SUSHI R6): * authenticator ^comment = "Derzeit für Emiga Anwendungsfälle nicht relevant"
