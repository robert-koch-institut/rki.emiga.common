...
* ^url = "https://emiga.rki.de/fhir/common/StructureDefinition/AffectedPersonR6"
* ^version = "0.5.0"
* ^date = "2026-05-18"
...
* meta.profile[emigaprofile] = "https://emiga.rki.de/fhir/common/StructureDefinition/AffectedPersonR6" 

* meta.extension contains $LastModifiedBy named lastModifiedBy 0..1 MS
* meta.extension[lastModifiedBy].value[x] only Reference(EmigaUserPractitionerR6)
...
// AUTO-DISABLED (SUSHI R6): * communication.language from CommonLanguages (extensible)
