...
* identifier[EmigaID] only IdentifierEmigaIDR6
...
* identifier[EmigaFileNumber] only IdentifierEmigaFileNumberR6
...
* identifier[SurvNetFileNumber] only IdentifierSurvNetFileNumberR6
